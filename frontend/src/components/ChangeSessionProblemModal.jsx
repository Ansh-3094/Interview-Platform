...
import { useUpdateSessionProblem } from "../hooks/useSession.js";
import {
  ORDERED_TRACKS,
  getAllProblems,
  getProblemsForTrack,
...
function ChangeSessionProblemModal({
  isOpen,
  onClose,
  sessionId,
  onProblemChanged,
  ...
  const handleChangeProb = async () => {
    if (!selectedProblemId || !sessionId) return;
  ...
  return (
    <div className="modal modal-open">
      <div className="modal-box max-w-4xl" onClick={(e) => e.stopPropagation()}>
        <h3 className="font-bold text-2xl mb-6">Change Problem</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <p className="text-base-content/75">
                  Select a category card to choose a new problem.
                </p>
        ...
        <div className="modal-action">
          ...
          <button
            ...
            onClick={handleChangeProb}
            disabled={updateProblemMutation.isPending || !selectedProblemId}
          >
            {updateProblemMutation.isPending ? (
              <LoaderIcon className="size-5 animate-spin" />
            ) : null}

            {updateProblemMutation.isPending ? "Changing..." : "Change Problem"}
          </button>
        </div>
      </div>
...
export default ChangeSessionProblemModal;
